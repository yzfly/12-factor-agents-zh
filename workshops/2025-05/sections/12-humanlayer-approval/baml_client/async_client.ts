...
class BamlStreamClient {
  ...
  ): BamlStream<(((partial_types.ClarificationRequest | null) | (partial_types.DoneForNow | null) | null) | ((partial_types.AddTool | null) | (partial_types.SubtractTool | null) | (partial_types.MultiplyTool | null) | (partial_types.DivideTool | null) | null)), ClarificationRequest | DoneForNow | AddTool | SubtractTool | MultiplyTool | DivideTool> {
    try {
      const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
      const collector = options.collector ? (Array.isArray(options.collector) ? options.collector : [options.collector]) : [];
      ...
      return new BamlStream<(((partial_types.ClarificationRequest | null) | (partial_types.DoneForNow | null) | null) | ((partial_types.AddTool | null) | (partial_types.SubtractTool | null) | (partial_types.MultiplyTool | null) | (partial_types.DivideTool | null) | null)), ClarificationRequest | DoneForNow | AddTool | SubtractTool | MultiplyTool | DivideTool>(
        raw,
        (a): (((partial_types.ClarificationRequest | null) | (partial_types.DoneForNow | null) | null) | ((partial_types.AddTool | null) | (partial_types.SubtractTool | null) | (partial_types.MultiplyTool | null) | (partial_types.DivideTool | null) | null)) => a,
