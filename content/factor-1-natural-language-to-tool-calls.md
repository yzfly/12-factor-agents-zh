...
From there, deterministic code can pick up the payload and do something with it. (More on this in [factor 3](./factor-3-own-your-context-window.md))
...
[← How We Got Here](./brief-history-of-software.md) | [Own Your Prompts →](./factor-2-own-your-prompts.md)