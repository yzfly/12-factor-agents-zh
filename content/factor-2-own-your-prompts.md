...
If the signature looks a little funny, we'll get to that in [factor 4 - tools are just structured outputs](./factor-4-tools-are-structured-outputs.md)
...
[← Natural Language To Tool Calls](./factor-1-natural-language-to-tool-calls.md) | [Own Your Context Window →](./factor-3-own-your-context-window.md)